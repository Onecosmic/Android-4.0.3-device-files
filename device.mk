...
# GPS config
PRODUCT_COPY_FILES += \
        device/samsung/aries/gps.xml:system/vendor/etc/gps.xml \
        device/samsung/aries/gps.conf:system/etc/gps.conf

$(call inherit-product, device/samsung/aries/device_base.mk)
